      ...
      >
        ...
        <div style={{
          ...
          <input
            ...
            placeholder={adminMode ? 'Search to add a review…' : 'Search movies & TV shows…'}
            style={{
              flex: 1,
        ...
        <div style={{ maxHeight: '60vh', overflowY: 'auto' }}>
          {error && (
            <div style={{ padding: '2rem', textAlign: 'center', color: '#e05555', fontSize: '0.9rem' }}>
              {error}
            </div>
          )}
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      color: item.media_type === 'tv' ? '#78b4c8' : 'var(--color-accent)',
                      background: item.media_type === 'tv' ? 'rgba(120,180,200,0.1)' : 'var(--color-accent-dim)',
