...
export default function Home() {
  ...
  const [stats, setStats] = useState({ total: 0, movies: 0, tv: 0, recommended: 0, avgRating: null });
          ...
          <div style={{
            ...
            <p style={{ fontSize: '0.9rem' }}>
              {reviews.length === 0
                ...
                : 'Try a different filter to find your reviews.'}
            </p>
          </div>
        )}
      </div>
...
function FeaturedHero({ review }) {
  const backdrop = review.backdropPath ? backdropUrl(review.backdropPath, 'original') : null;
  const poster = review.posterPath ? posterUrl(review.posterPath, 'lg') : null;
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        inset: 0,
        background: `
          linear-gradient(to right, rgba(7,7,15,0.95) 0%, rgba(7,7,15,0.5) 50%, transparent 100%),
      ...
      <div className="page-container" style={{
        ...
        {poster && (
          <div style={{
            ...
            <img src={poster} alt={review.title} style={{ width: '100%', display: 'block' }} />
          </div>
        )}
        ...
        <div style={{ maxWidth: '560px' }}>
          <div style={{ marginBottom: '0.75rem', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
            ...
            <span style={{
              ...
              color: review.mediaType === 'tv' ? '#78b4c8' : 'rgba(255,255,255,0.5)',
              textTransform: 'uppercase',
            }}>
...
function EmptyHero() {
  return (
    <div style={{
      ...
      background: `
        radial-gradient(ellipse at center, rgba(var(--color-accent-rgb), 0.05) 0%, transparent 70%),
        var(--color-bg)
      `,
      borderBottom: '1px solid var(--color-border)',
    }}>
      <div style={{ textAlign: 'center', animation: 'fadeIn 0.6s ease' }}>
        ...
        <p style={{ fontSize: '1rem', color: 'var(--color-text-muted)', maxWidth: '400px', margin: '0 auto' }}>
          Personal reviews of the films and series that left a mark.
        </p>
      </div>
    </div>
  );
